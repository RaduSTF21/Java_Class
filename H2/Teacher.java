...
public class Teacher extends Person{
     ...
     */
    public Teacher(String name, java.time.LocalDare birthDate, Project[] proposedProjects){
        super(name,birthDate);
        this.proposedProjects = proposedProjects;
    }
    /**
     * Returns an array of projects proposed by the teacher
    ...
    /**
    * Retruns a string representation of the teacher
