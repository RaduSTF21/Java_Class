/**
 * Represent a project proposed by a teacher.
...
public class Project{
    ...
    {
        String assigned = (assignedStudent != null) ? assignedStudent.getRegistationNumber() : "None";
        return "Project[projectName=" + projectName + ", proposedBy= "+ proposedBy.getName() + ", assignedStudent=" + assigned + "]";
    }
    /**
     * Checks if the project is equal to another object
